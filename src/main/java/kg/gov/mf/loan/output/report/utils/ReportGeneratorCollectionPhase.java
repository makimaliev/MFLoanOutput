...
import kg.gov.mf.loan.output.report.model.CollectionPhaseReportData;
...
*/
    public HSSFWorkbook generateReportByTemplate(ReportTemplate reportTemplate){
        ...
        CollectionPhaseReportData SummaryLoan = new CollectionPhaseReportData();





        SummaryLoan = new CollectionPhaseReportDataManager().getReportDataGrouped(SummaryLoan,reportTemplate);
...
//        Sheet.setColumnWidth(count,(short)width);count++;
        ...
        Cell.setCellValue("Информация по взысканию");
...
//        ColumnCount++;
        ...
        CollectionPhaseReportData MainData = SummaryLoan;
...
//        ColumnCount++;
        ...
        CollectionPhaseReportData GroupData1[] = MainData.getChilds();
...
//                ColumnCount++;
            ...
            CollectionPhaseReportData GroupData2[] = GroupData1[x].getChilds();
...
//                    ColumnCount++;
                ...
                CollectionPhaseReportData PersonData[] = GroupData2[y].getChilds();
...
//                        ColumnCount++;
                    ...
                    if(iDetail4)
                    {
                        ...
                        CollectionPhaseReportData CreditData[] = PersonData[p].getChilds();
...
//                            ColumnCount++;
                            ...
                            if(iDetail4)
                            {
                                ...
                                CollectionPhaseReportData PaymentData[] = CreditData[c].getChilds();
...
//                                    ColumnCount++;
                                    ...
                                    if (PaymentData[pp].getCollection_phase_start_date() != null)
                                    {
                                        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_STRING);
                                        Cell.setCellStyle(CellStyleDate);
                                        Cell.setCellValue(PaymentData[pp].getCollection_phase_start_date());
                                        ColumnCount++;
