...
*/
    public HSSFWorkbook generateReportByTemplate(ReportTemplate reportTemplate){
        ...
        PaymentScheduleReportData SummaryLoan = new PaymentScheduleReportData();





        SummaryLoan = new PaymentScheduleReportDataManager().getReportDataGrouped(SummaryLoan,reportTemplate);
        ...
        Cell.setCellValue("Информация по графикам погашения");
        ...
        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_STRING);
        Cell.setCellStyle(CellStyleHeader);
        Cell.setCellValue("Всего освоено");
        ColumnCount++;
        ...
        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_STRING);
        Cell.setCellStyle(CellStyleHeader);
        Cell.setCellValue("Всего по графику");
        ColumnCount++;
        ...
        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_STRING);
        Cell.setCellStyle(CellStyleHeader);
        Cell.setCellValue("Статус платежа");
        ColumnCount++;
        ...
        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_STRING);
        Cell.setCellStyle(CellStyleHeader);
        Cell.setCellValue("нак. процентам");
        ColumnCount++;


        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_STRING);
        Cell.setCellStyle(CellStyleHeader);
        Cell.setCellValue("нак. штрафам");
        ColumnCount++;
        ...
        PaymentScheduleReportData MainData = SummaryLoan;
        ...
        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
        Cell.setCellStyle(CellStyleDataSum);
        Cell.setCellValue((MainData.getDisbursement()/Thousands));
        ColumnCount++;


        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
        Cell.setCellStyle(CellStyleDataSum);
        Cell.setCellValue(((MainData.getTotalPayment())/Thousands));
        ColumnCount++;

        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
        Cell.setCellStyle(CellStyleDataSum);
        Cell.setCellValue((MainData.getPrincipal_payment()/Thousands));
        ColumnCount++;

        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
        Cell.setCellStyle(CellStyleDataSum);
        Cell.setCellValue((MainData.getInterest_payment()/Thousands));
        ColumnCount++;

        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
        Cell.setCellStyle(CellStyleDataSum);
        Cell.setCellValue((MainData.getCollected_interest_payment()/Thousands));
        ColumnCount++;

        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
        Cell.setCellStyle(CellStyleDataSum);
        Cell.setCellValue((MainData.getCollected_penalty_payment()/Thousands));
        ColumnCount++;
        ...
        PaymentScheduleReportData GroupData1[] = MainData.getChilds();
        ...
        for(int x=0;x<GroupData1.length;x++)
        {
            if(iDetail1)
            {
                ...
                Cell.setCellValue((GroupData1[x].getDisbursement()/Thousands));
                ColumnCount++;
                ...
                Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                Cell.setCellStyle(CellStyleDataGroup1);
                Cell.setCellValue((GroupData1[x].getTotalPayment()/Thousands));
                ColumnCount++;

                Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                Cell.setCellStyle(CellStyleDataGroup1);
                Cell.setCellValue(((GroupData1[x].getPrincipal_payment())/Thousands));
                ColumnCount++;

                Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                Cell.setCellStyle(CellStyleDataGroup1);
                Cell.setCellValue(((GroupData1[x].getInterest_payment())/Thousands));
                ColumnCount++;


                Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                Cell.setCellStyle(CellStyleDataGroup1);
                Cell.setCellValue(((GroupData1[x].getCollected_interest_payment())/Thousands));
                ColumnCount++;


                Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                Cell.setCellStyle(CellStyleDataGroup1);
                Cell.setCellValue(((GroupData1[x].getCollected_penalty_payment())/Thousands));
                ColumnCount++;
            ...
            PaymentScheduleReportData GroupData2[] = GroupData1[x].getChilds();
            ...
            for(int y=0;y<GroupData2.length;y++)
            {
                if(iDetail2)
                {
                    ...
                    Cell.setCellValue((GroupData2[y].getDisbursement()/Thousands));
                    ColumnCount++;

                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                    Cell.setCellStyle(CellStyleDataGroup2);
                    Cell.setCellValue((GroupData2[y].getTotalPayment()/Thousands));
                    ColumnCount++;


                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                    Cell.setCellStyle(CellStyleDataGroup2);
                    Cell.setCellValue((GroupData2[y].getPrincipal_payment()/Thousands));
                    ColumnCount++;


                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                    Cell.setCellStyle(CellStyleDataGroup2);
                    Cell.setCellValue((GroupData2[y].getInterest_payment()/Thousands));
                    ColumnCount++;


                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                    Cell.setCellStyle(CellStyleDataGroup2);
                    Cell.setCellValue((GroupData2[y].getCollected_interest_payment()/Thousands));
                    ColumnCount++;


                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                    Cell.setCellStyle(CellStyleDataGroup2);
                    Cell.setCellValue((GroupData2[y].getCollected_penalty_payment()/Thousands));
                    ColumnCount++;
                ...
                PaymentScheduleReportData PersonData[] = GroupData2[y].getChilds();
                ...
                for(int p=0;p<PersonData.length;p++)
                {
                    if(iDetail3)
                    {
                        ...
                        Cell.setCellValue((PersonData[p].getDisbursement()/Thousands));
                        ColumnCount++;

                        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                        Cell.setCellStyle(CellStyleDataPerson);
                        Cell.setCellValue((PersonData[p].getTotalPayment()/Thousands));
                        ColumnCount++;


                        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                        Cell.setCellStyle(CellStyleDataPerson);
                        Cell.setCellValue((PersonData[p].getPrincipal_payment()/Thousands));
                        ColumnCount++;


                        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                        Cell.setCellStyle(CellStyleDataPerson);
                        Cell.setCellValue((PersonData[p].getInterest_payment()/Thousands));
                        ColumnCount++;


                        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                        Cell.setCellStyle(CellStyleDataPerson);
                        Cell.setCellValue((PersonData[p].getCollected_interest_payment()/Thousands));
                        ColumnCount++;


                        Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                        Cell.setCellStyle(CellStyleDataPerson);
                        Cell.setCellValue((PersonData[p].getCollected_penalty_payment()/Thousands));
                        ColumnCount++;
                    ...
                    if(iDetail4)
                    {
                        ...
                        PaymentScheduleReportData CreditData[] = PersonData[p].getChilds();
...
//
                            ...
                            Cell.setCellValue((CreditData[c].getDisbursement()/(Thousands*ExRate)));
                            ColumnCount++;

                            Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                            Cell.setCellStyle(CellStyleData);
                            Cell.setCellValue((CreditData[c].getTotalPayment()/(Thousands*ExRate)));
                            ColumnCount++;

                            Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                            Cell.setCellStyle(CellStyleData);
                            Cell.setCellValue((CreditData[c].getPrincipal_payment()/(Thousands*ExRate)));
                            ColumnCount++;

                            Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                            Cell.setCellStyle(CellStyleData);
                            Cell.setCellValue((CreditData[c].getInterest_payment()/(Thousands*ExRate)));
                            ColumnCount++;

                            Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                            Cell.setCellStyle(CellStyleData);
                            Cell.setCellValue((CreditData[c].getCollected_interest_payment()/(Thousands*ExRate)));
                            ColumnCount++;

                            Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                            Cell.setCellStyle(CellStyleData);
                            Cell.setCellValue((CreditData[c].getCollected_penalty_payment()/(Thousands*ExRate)));
                            ColumnCount++;
                            ...
                            if(iDetail4)
                            {
                                ...
                                PaymentScheduleReportData PaymentData[] = CreditData[c].getChilds();
...
//                                    ColumnCount++;
                                    ...
                                    Cell.setCellValue(PaymentData[pp].getExpectedDate());
                                    ColumnCount++;

                                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                                    Cell.setCellStyle(CellStyleData);
                                    Cell.setCellValue((PaymentData[pp].getDisbursement()/(Thousands)));
                                    ColumnCount++;

                                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                                    Cell.setCellStyle(CellStyleData);
                                    Cell.setCellValue((PaymentData[pp].getTotalPayment()/(Thousands)));
                                    ColumnCount++;

                                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                                    Cell.setCellStyle(CellStyleData);
                                    Cell.setCellValue((PaymentData[pp].getPrincipal_payment()/(Thousands)));
                                    ColumnCount++;

                                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                                    Cell.setCellStyle(CellStyleData);
                                    Cell.setCellValue((PaymentData[pp].getInterest_payment()/(Thousands)));
                                    ColumnCount++;

                                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                                    Cell.setCellStyle(CellStyleData);
                                    Cell.setCellValue((PaymentData[pp].getCollected_interest_payment()/(Thousands)));
                                    ColumnCount++;

                                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_NUMERIC);
                                    Cell.setCellStyle(CellStyleData);
                                    Cell.setCellValue((PaymentData[pp].getCollected_penalty_payment()/(Thousands)));
                                    ColumnCount++;

                                    Cell = Row.createCell(ColumnCount, HSSFCell.CELL_TYPE_STRING);
                                    Cell.setCellStyle(CellStyleDataLeft);
                                    Cell.setCellValue(PaymentData[pp].getInstallment_state_id());
                                    ColumnCount++;
